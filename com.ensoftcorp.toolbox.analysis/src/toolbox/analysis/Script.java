...
import toolbox.library.util.ScriptUtilities;
...
public abstract class Script {
	...
	protected Q appContext = ScriptUtilities.app();
	...
	public void setContext(Q context) {
		...
		appContext = context.intersection(ScriptUtilities.app()).retainNodes().induce(context);
		clearEnvelopeCache();
	}
